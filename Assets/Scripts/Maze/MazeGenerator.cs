...
public class MazeGenerator : MonoBehaviour
{
    ...
    public float visualiztionSpeed = 0.05f;
    ...
    public void Generatemaze()
    {
        ...
        {
            StartCoroutine(GenerateDFSVisualized());
        }
        else
        {
            GenerateWuthDFS();
    ...
    IEnumerator GenerateDFSVisualized()
    {
        MazeCell current = maze[0, 0];
        current.visited = true;
        ...
        yield return new WaitForSeconds(visualiztionSpeed);
